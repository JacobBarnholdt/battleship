...
class Gameboard:
    def __init__(self, master):
        ...
        self.matrix2   = None
        self.btn_5_ship = Button(frame, text = "Creat 5 ship", command = self.create_5_ship)
        self.btn_5_ship.grid(row = 2, column = 1)
        self.btn_4_ship = Button(frame, text = "Creat 4 ship", command = self.create_4_ship)
        self.btn_4_ship.grid(row = 3, column = 1)
        self.btn_3_ship = Button(frame, text = "Creat 3 ship", command = self.create_3_ship)
        self.btn_3_ship.grid(row = 4, column = 1)
        self.btn_2_ship = Button(frame, text = "Creat 2 ship", command = self.create_2_ship)
        self.btn_2_ship.grid(row = 5, column = 1)
        self.btn_1_ship = Button(frame, text = "Creat 1 ship", command = self.create_1_ship)
